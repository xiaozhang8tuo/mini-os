...
argv` 是一个类型为 `char *[] 的数组，其中每个元素都是一个 char *。即字符串数组
...
|    argv[argc]     |  ← NULL
+-------------------+
|    argv[argc-1]   |  ← 最后一个参数 (arg3)
+-------------------+
|    argv[argc-2]   |  ← 倒数第二个参数 (arg2)
+-------------------+
|    argv[1]        |  ← 第一个参数 (arg1)
+-------------------+
|    argv[0]        |  ← 程序名称 (./program)
...
![image-20250302203540585](.assets/image-20250302203540585.png)



![image-20250302205458729](.assets/image-20250302205458729.png)

对于不同的文件系统，使用统一的链接进行挂载和管理

![image-20250302205709845](.assets/image-20250302205709845.png)



## 29 磁盘分区管理 ##

![image-20250305130059462](.assets/image-20250305130059462.png)



![image-20250305132003129](.assets/image-20250305132003129.png)



![image-20250307130406391](.assets/image-20250307130406391.png)

分区格式

![image-20250307130624255](.assets/image-20250307130624255.png)



![image-20250310125543301](.assets/image-20250310125543301.png)

## 30 FAT16文件系统 ##

![image-20250311192428086](.assets/image-20250311192428086.png)



![image-20250312130735856](.assets/image-20250312130735856.png)



![image-20250312131253685](.assets/image-20250312131253685.png)

第二个FAT表相当于第一个FAT表的备份，dbr保存文件系统的meta信息

![image-20250312131400056](.assets/image-20250312131400056.png)
